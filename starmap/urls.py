...
urlpatterns = [
    ...
    path("api/agencies/<int:pk>/publish-scan/", views.api_publish_scan, name="api-publish-scan"),
    path("api/agencies/<int:pk>/unpublish-scan/", views.api_unpublish_scan, name="api-unpublish-scan"),
